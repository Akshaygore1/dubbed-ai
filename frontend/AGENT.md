...
- Keep the captured Dubbed AI visual direction in `PRODUCT.md` and `DESIGN.md`: a calm localization studio with editorial brand moments, restrained product UI, and creator content taking visual priority.
